...
python3 -m pip install -v --no-cache-dir --global-option="--cpp_ext" --global-option="--cuda_ext" ./apex

#python3 apex.py

#python3 ./apex/setup.py "--cpp_ext" --global-option="--cuda_ext"

#python3 pytorch_transformers/models/hf_trainer.py --training_data_path train_with_winograd_typed.jsonl --validation_data_path dev_with_winograd_typed.jsonl  --mcq_model bert-mcq-concat  --tie_weights_weighted_sum --bert_model bert-large-cased --output_dir  /scratch/sjaliga1/bert-large-model2 --num_train_epochs 10 --train_batch_size 32  --do_eval --do_train --max_seq_length 128 --do_lower_case --gradient_accumulation_steps 16 --eval_freq 1000 --learning_rate 9e-6  --warmup_steps 400 --weight_decay 0.001 --fp16

#python3 pytorch_transformers/models/hf_scorer.py --input_data_path dev_typed.jsonl   --max_number_premises 1 --max_seq_length 80 --eval_batch_size 1 --model_dir /scratch/sjaliga1/bert-large-model2 --bert_model bert-large-cased --mcq_model bert-mcq-concat  --output_data_path /scratch/sjaliga1/evaluation

python3 pytorch_transformers/models/hf_trainer.py --training_data_path inputdata/train_typed_without_wiki.jsonl --validation_data_path inputdata/dev_typed_without_wiki.jsonl  --mcq_model roberta-mcq-weighted-sum  --tie_weights_weighted_sum --bert_model roberta-large --output_dir  /scratch/sjaliga1/roberta-atomic-ws --num_train_epochs 10 --train_batch_size 32  --do_eval --do_train --max_seq_length 128 --do_lower_case --gradient_accumulation_steps 16 --eval_freq 500 --learning_rate 9e-6  --warmup_steps 400 --weight_decay 0.001 --fp16

python3 pytorch_transformers/models/hf_scorer.py --input_data_path inputdata/dev_typed_without_wiki.jsonl --max_number_premises 1 --max_seq_length 80 --eval_batch_size 1 --model_dir /scratch/sjaliga1/roberta-atomic-ws --bert_model roberta-large --mcq_model roberta-mcq-concat  --output_data_path /scratch/sjaliga1/evaluation-atomic-ws

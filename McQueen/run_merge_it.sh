...
#python3 preprare_dataset.py train.jsonl train-labels.lst
...
#python3 clean_dataset.py train_with_winograd_typed.jsonl
...
#python3 -m pip install pytorch_transformers
